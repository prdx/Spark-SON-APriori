...
In this progress report, we will implement the first task to generate local frequent itemsets.
...
The second major task is to find the global frequent winner itemset from local itemsets.
